...
public:
    ...
    // constructor
    Mesh(vector<Vertex> vertices, vector<unsigned int> indices, vector<Texture> textures, MaterialModel mat)
    {
    ...
    void Draw(Shader& shader)
    {
        ...
        glBindBufferRange(GL_UNIFORM_BUFFER, 0, uniformBlockIndex, 0, sizeof(MaterialModel));
